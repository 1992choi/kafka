...
public class OrderSerdeConsumer<K extends Serializable, V extends Serializable> {
    ...
    public static void main(String[] args) {
        ...
        OrderSerdeConsumer<String, OrderModel> orderSerdeConsumer = new OrderSerdeConsumer<String, OrderModel>(props, List.of(topicName));
        orderSerdeConsumer.initConsumer();
        String commitMode = "async";

        orderSerdeConsumer.pollConsumes(100, commitMode);
        orderSerdeConsumer.closeConsumer();
    }
